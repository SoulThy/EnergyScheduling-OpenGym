...
MODULE = "RunNoLearningFailureWorkersOrCloud"
...
def run_simulation(policy: Node.NoLearningPolicy) -> None:
    session_id = f"{SESSION_ID}_{policy.name}_WORKERS_OR_CLOUD_FAILURE"
    ...
    # Worker speeds for this scenario (keep consistent with legacy no-learning cloud runs).
    worker_specs = [
        (1, 1.0, worker_batt_1),
        (2, 0.9, worker_batt_2),
        (3, 0.6, worker_batt_3),
...
if __name__ == "__main__":
    ...
    print("All failure simulations (WORKERS_OR_CLOUD) completed.")
